...
function Home() {
    ...
    return( 
      ...
      <section class="infetech-banner-area">
               ...
               <div class="row">
                  <div class="col-lg-12">
                     <div class="infetech-banner-content">
                        <h4 class="title">Experience the best IT Solutions</h4>
                        <h1 class="" >IT Solutions <img src="assets/images/banner-icon.png" alt=""/> <br/> Services</h1>
                        <a class="main-btn"  href="#">Learn More</a>
                        <img class="banner-arrow"  src="assets/images/banner-arrow.png" alt=""/>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <section class="infetech-about-area">
         <div class="container">
            <div class="row">
               <div class="col-lg-6">
                  <div class="infetech-about-thumb">
                     <img src="assets/images/about-thumb-1.jpg" alt=""/>
                     <img class="thumb" src="assets/images/about-thumb-2.jpg" alt=""/>
                     <div class="about-box">
               ...
               <div class="col-lg-6">
                  <div class="infetech-about-content">
                     ...
                     <ul>
                        <li><i class="fas fa-check-circle"></i> Exploring version oflorem veritatis proin</li>
                        <li><i class="fas fa-check-circle"></i> Auctor aliquet aenean simply free text veritatis quis</li>
                        <li><i class="fas fa-check-circle"></i> Consequat ipsum nec lorem sagittis sem nibh.</li>
                     </ul>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="single-infetech-serice-item">
                     ...
                     <div class="content">
                        ...
                        <h3 class="title"><a href="#">Perfect solutions that business demands</a></h3>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6">
                  <div class="single-infetech-serice-item">
                     ...
                     <div class="content">
                        ...
                        <h3 class="title"><a href="#">Reduced Spending with IT Talent Sourcing</a></h3>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6">
                  <div class="single-infetech-serice-item">
                     ...
                     <div class="content">
                        ...
                        <h3 class="title"><a href="#">Access to Experts and the Latest Technology</a></h3>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="container">
            ...
            <div class="row infetech-feature">
               ...
               <div class="col-lg-2">
                  <div class="single-infetech-feature-item">
                     <div class="icon">
                        <svg id="_x33_0" enable-background="new 0 0 64 64" height="60px" viewBox="0 0 64 64" width="60px" xmlns="http://www.w3.org/2000/svg">
                           <g>
                              <path fill="#b882fc" d="m32 17c-8.271 0-15 6.729-15 15s6.729 15 15 15 15-6.729 15-15-6.729-15-15-15zm0 28c-7.168 0-13-5.832-13-13s5.832-13 13-13 13 5.832 13 13-5.832 13-13 13z"/>
                              <path fill="#b882fc" d="m37 27v-1c0-2.757-2.243-5-5-5s-5 2.243-5 5v1c-1.103 0-2 .897-2 2v10c0 1.103.897 2 2 2h10c1.103 0 2-.897 2-2v-10c0-1.103-.897-2-2-2zm-8-1c0-1.654 1.346-3 3-3s3 1.346 3 3v1h-6zm-2 13v-10h10l.001 10z"/>
                              <path fill="#b882fc" d="m32 30c-1.654 0-3 1.346-3 3 0 1.302.839 2.402 2 2.816v2.184h2v-2.184c1.161-.414 2-1.514 2-2.816 0-1.654-1.346-3-3-3zm0 4c-.552 0-1-.449-1-1s.448-1 1-1 1 .449 1 1-.448 1-1 1z"/>
               ...
               <div class="col-lg-2">
                  <div class="single-infetech-feature-item">
                     <div class="icon">
                        <svg id="Capa_1" fill="#b882fc" enable-background="new 0 0 512 512" height="60px" viewBox="0 0 512 512" width="60px" xmlns="http://www.w3.org/2000/svg">
                           <g>
                              <g>
               ...
               <div class="col-lg-2">
                  <div class="single-infetech-feature-item">
                     <div class="icon">
                        <svg fill="#b882fc" id="Layer_5" enable-background="new 0 0 62 62" height="60px" viewBox="0 0 62 62" width="60px" xmlns="http://www.w3.org/2000/svg">
                           <g>
                              <path d="m4 4h2v4h-2z"/>
                              <path d="m8 4h2v4h-2z"/>
                     ...
                     <div class="content">
                        <h4 class="title"><a href="#">Data <br/> Analysis</a></h4>
                        <p>Lorem Ipsum has been the industry text ever since then.</p>
                     </div>
                  </div>
               </div>
      ...
      <div class="infetech-cta-area">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <div class="infetech-cta-box">
                     <div class="row">
                        <div class="col-lg-3">
                           <div class="cta-thumb">
                        ...
                        <div class="col-lg-9">
                           <div class="cta-content">
                              <h2 class="title">We’re Ready Develop Your Site!</h2>
                              <div class="row align-items-center">
                                 <div class="col-lg-8">
                                    <ul>
                                       <li><i class="fas fa-check-circle"></i> Exploring version oflorem veritatis proin</li>
                                 ...
                                 <div class="col-lg-4">
                                    <a href="#" class="main-btn ml-30">Learn More</a>
                                 </div>
                              </div>
                           </div>
                        </div>
      ...
      <br/>
      <br/>
      <section class="infetech-project-area pt-115 ">
         <div class="container">
         ...
         <div class="container-fluid pl-160 pr-160">
            <div class="row infetech-project">
               <div class="col-lg-3">
      ...
      <div class="infetech-sponser-area">
         <div class="container">
            <div class="row infetech-sponser">
               <div class="col-lg-2">
      ...
      <section class="infetech-testimonial-area">
         <div class="container">
            ...
            <div class="row infetech-testimonial">
               <div class="col-lg-6">
                  <div class="single-testimonial-box">
                     ...
                     <div class="single-testimonial-item">
                        ...
                        <p>This is due to their excellent service, competitive pricing and customer support. It’s refresing to get such a personal touch. Duis aute lorem ipsum is simply free text reprehen.</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-6">
      ...
      <section class="infetech-team-area">
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="single-tema-item animated">
                     <div class="thumb">
            ...
            <div class="row align-items-center">
               <div class="col-lg-7">
                  <div class="video-content">
                     <div class="play-btn">
                        <a class="" href="#"><i class="fas fa-play"></i></a>
                     </div>
               ...
               <div class="col-lg-5">
                  <div class="video-content-wrapper">
                     <div class="video-content-box">
                        <div class="item">
                           <h4 class="title">9280</h4>
                           <span>We have satisfied <br/> customers</span>
                        </div>
                     </div>
                     <div class="video-content-box item-2">
                        <div class="item">
                           <h4 class="title">6420</h4>
      ...
      <div class="footer-copyright text-center">
         <p>© All Copyright 2022 by <a href="#">Layerdrops.com</a> </p>
      </div>
         </div>
    )
    }
